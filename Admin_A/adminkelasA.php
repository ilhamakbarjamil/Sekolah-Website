...
<body>
    ...
    <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body p-0">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item bg-dark">
                    <a href="../Logout/logout.php" class="text-danger text-decoration-none d-flex align-items-center">
    ...
    <nav class="sidebar d-none d-md-block">
        ...
        <a href="../Logout/logout.php" class="text-danger"><i class="fas fa-sign-out-alt"></i> Logout</a>
    </nav>
